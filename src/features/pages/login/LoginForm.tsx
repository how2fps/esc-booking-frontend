                    ...
                    <div className="content flex items-center justify-center">
                        <div id="form-login" className='xl:basis-1/3 lg:basis-1/2 sm:basis-2/3 max-sm:w-full'>
                            ...
                            <form className="md:mt-10 mt-6">
                                ...
                                <div className="email ">
                                    <label htmlFor="username" className='text-variant1'>Email address<span className='text-primary'>*</span></label>
                                    <input type="text" className="border-line px-4 pt-3 pb-3 w-full rounded-lg mt-2" id="username"  placeholder="" required />
                                </div>

                                <div className="pass mt-5">
                                    <label htmlFor="password" className='text-variant1'>Password<span className='text-primary'>*</span></label>
                                    <input className="border-line px-4 pt-3 pb-3 w-full rounded-lg mt-2 pr-10 text-black bg-[#d1d1d1]" id="password" type="password" placeholder="" required />
                                </div>
                            ...
                            <div className="flex items-center justify-center gap-2 mt-5">
                                ...
                                <Link href={'/signup'} className='text-button-sm text-black has-line'>Register</Link>
                            </div>
                        </div>
                    </div>
                </div>
