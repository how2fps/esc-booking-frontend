              ...
              <div className='login-us lg:py-20 md:py-14 py-10'>
                     <div className="container">
                            <div className="content flex items-center justify-center">
                                   <div id="form-signup" className='xl:basis-1/3 lg:basis-1/2 sm:basis-2/3 max-sm:w-full'>
                                          <div className="heading3 text-center">Sign Up</div>
                                          <form className="md:mt-10 mt-6" onSubmit={handleSubmit}>
                                                 <div className="name mb-5">
                                                        <label htmlFor="name" className='text-variant1'>Name<span className='text-primary'>*</span></label>
                                                        <input
                                                               type="text"
                                                               id="name"
                                                 ...
                                                 <div className="email mb-5">
                                                        <label htmlFor="email" className='text-variant1'>Email address<span className='text-primary'>*</span></label>
                                                        <input
                                                               type="email"
                                                               id="email"
                                                 ...
                                                 <div className="pass mb-5 relative">
                                                        ...
                                                        >
                                                        {showPassword ? <EyeSlash size={26} weight="bold" /> : <Eye size={26} weight="bold" />}
                                                        </button>
                                                 </div>
                                                 ...
                                                 <div className="pass mb-5 relative">
                                                        ...
                                                        className="absolute right-3 top-[46px] text-white p-0 bg-transparent border-none outline-none focus:ring-0 hover:opacity-70"
                                                        >
                                                        {showConfirmPassword ? <EyeSlash size={26} weight="bold" /> : <Eye size={26} weight="bold" />}
                                                        </button>
                                                 </div>
